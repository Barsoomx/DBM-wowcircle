...
L.FilterVoidFormSay			= "Не отправлять в чат позицию/счёт, когда находитесь в пустой форме"
...
L.AudioPull					= "Включить аудио отсчет для /pull"
L.BigTimerNumbers			= "Включить визуальный отсчет с золотыми цифрами для /pull"
